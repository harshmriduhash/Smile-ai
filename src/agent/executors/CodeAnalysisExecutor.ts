      ...
      return {
        ...
        error:
          error instanceof Error
            ? error.message
            : "Unknown error in code analysis",
      };
    }
  }
  ...
  private generateMetricInsights(analysis: CodeAnalysis): MetricInsights {
    return {
      ...
      maintainability: {
        ...
        interpretation: this.interpretMaintainability(
      ...
      testability: {
        ...
        recommendations: this.getTestabilityRecommendations(
          analysis.metrics.testability
        ),
      },
      documentation: {
        score: analysis.metrics.documentation,
        interpretation: this.interpretDocumentation(
          analysis.metrics.documentation
        ),
        recommendations: this.getDocumentationRecommendations(
          analysis.metrics.documentation
        ),
      },
    };
...
<body>
            ...
            <div>
                ...
                ${
                  report.overview.framework
                    ? `<span>Framework: ${report.overview.framework}</span>`
                    : ""
                }
            </div>
        </div>
        ...
        <div class="overview-grid">
            <div class="metric-card">
                ...
                <div class="metric-value">${
                  report.metrics.complexity.score
                }</div>
            ...
            <div class="metric-card">
                ...
                <div class="metric-value">${
                  report.metrics.maintainability.score
                }</div>
            ...
            <div class="metric-card">
                <h3>Testability</h3>
                <div class="metric-value">${
                  report.metrics.testability.score
                }</div>
            ...
            <div class="metric-card">
                <h3>Documentation</h3>
                <div class="metric-value">${
                  report.metrics.documentation.score
                }</div>
  ...
  private async showSuggestionDetail(
...
Location: ${suggestion.file}:${suggestion.range.start.line + 1}:${
      suggestion.range.start.character + 1
    }
${suggestion.fix ? `\nSuggested Fix:\n${suggestion.fix}` : ""}
`;
...
Please provide your analysis in a structured JSON format.`;
  ...
  private getComplexityRecommendations(score: number): string[] {
    ...
    if (score > 20) {
      recommendations.push(
        "Consider extracting complex logic into separate utility classes"
      );
      recommendations.push(
        "Implement design patterns to better organize complex logic"
      );
    }
    if (score > 30) {
      recommendations.push(
        "Perform major refactoring to simplify code structure"
      );
      recommendations.push(
        "Consider rewriting complex parts using more maintainable approaches"
      );
    }
